@echo off
title Dual LED Controller - Tang Nano 4K
color 0A

echo ╔═══════════════════════════════════════════════════╗
echo ║              DUAL LED CONTROLLER           ║
...
echo    [ ] Reset board
echo    [ ] Verify display
echo    [ ] Verify LED1 blinks with clock (1Hz)
echo    [ ] Verify LED2 blinks when button pressed (5Hz)
echo.
